...
contract RPM is ERC20Burnable {
    ...
    bytes32 private constant NAME_HASH = 0x4e807f1ece40511315bf2381da4aec564b90dcbf4baa5dfd9dc764f6b5d92660;
    ...
    modifier onlyMinter() {
        require(msg.sender == _minter, "RPM:: NOT_MINTER");
        _;
    }

    modifier onlyTimelock() {
        require(msg.sender == timelock, "RPM:: NOT_TIMELOCK");
        _;
    }
    ...
    function updateMinter(address newMinter) external {
        require(!_minterStatus, "RPM:: MINTER_ALREADY_INITIALIZED");
        require(newMinter != address(0), "RPM:: INVALID_MINTER_ADDRESS");
        _minter = newMinter;
        _minterStatus = true;
    }
    ...
    function _validateSignedData(
        ...
        require(recoveredAddress != address(0) && recoveredAddress == signer, "RPM:: INVALID_SIGNATURE");
    }
